...
const Footer = () => {
  return (
    <div className='bg-gradient-to-b from-orange-50 to-amber-100 mt-20'>
      <div className='modern-card mx-4 mb-8'>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 py-16 px-8 text-sm'>
          ...
          <div>
              ...
              <p className='w-full md:w-2/3 text-amber-700 leading-relaxed text-base'>
          ...
          <div>
              ...
              <ul className='flex flex-col gap-3 text-amber-700'>
